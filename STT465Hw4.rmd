...
STT 465 – Fall 2019
Homework 4 – Due 10/30/2019 (In Class)
Instruction:
...
Clearly interpret the slope for each line.

```{r}
Slope
```

The slope for all the lines is 0.02673734.
